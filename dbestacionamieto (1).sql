...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-05-2017 a las 23:56:26
...
INSERT INTO `cocheras` (`numCochera`, `esDisca`, `ocupada`, `marca`, `patente`, `color`, `hsingreso`, `hssalida`, `empingreso`, `empsalida`) VALUES
('2_2', 'si', 'si', 'qwerfd', 'wer', 'qwe', 1496007148, 0, 'empleado1', ' ');
